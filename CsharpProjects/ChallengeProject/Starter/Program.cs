...
foreach (string name in studentNames)
{
    ...
    */
    ...
    currentStudentOverallGrade = (decimal)((decimal)sumExamScores + ((decimal)(sumExtraScores / 10))) / examAssignments;
    currentStudentExtraGrade = sumExtraScores / extraAssignments;
    currentStudentCreditPoints = (decimal)(sumExtraScores / 10) / examAssignments;
    ...
    Console.Write($"{currentStudent}\t\t{currentStudentGrade}\t\t{currentStudentOverallGrade}");
    Console.WriteLine($"\t{currentStudentLetterGrade}\t{currentStudentExtraGrade} ({currentStudentCreditPoints} pts)");
}
